...
class PurchasePredictionController extends Controller
{
    public function index() 
    {
        ...
        return Inertia::render('purchase-predictions/forecasting', [
    ...
    {
        return Inertia::render('purchase-predictions/purchase-form');
    }
    ...
    public function purchaseStore(ForecastingFormRequest $request)
    {
        ...
        return redirect()->route('purchase-predictions.index');
    }
